...
MIC_DEVICE_INDEX    =9  # Your microphone (local speaker)
...
VAD_MODE      = 1      # 0 (lenient) → 3 (aggressive); 3 filters most non-speech

# ── Utterance Boundary Detection ─────────────────────────────────
SILENCE_TIMEOUT_S = 1.6   # Seconds of silence before flushing utterance to Whisper
MIN_SPEECH_S      = 0.25   # Ignore utterances shorter than this (avoids noise bursts)
